      ...
      <div class="content-wrapper">
        ...
        <div class="featured-section">
          ...
          <div v-if="loading" class="loading-container">
            ...
            <p class="loading-text">{{ crawlingMessage || '최신 뉴스를 불러오는 중...' }}</p>
          </div>
          
          <div v-else-if="featuredNews" class="featured-card" @click="openNewsDetail(featuredNews)">
            ...
            <div class="featured-content">
              ...
              <p class="featured-summary">{{ featuredNews.summary || '요약 정보가 없습니다.' }}</p>
          ...
          <div v-else class="featured-card">
            ...
            <div class="featured-content">
              <h3 class="featured-title">시장 변동성이 경제 불확실성 속에서 지속</h3>
              <p class="featured-summary">글로벌 시장은 혼재된 경제 신호와 지정학적 발전에 대한 투자자들의 반응으로 또 다른 변동의 하루를 경험했습니다.</p>
              <div class="featured-meta">
                <span class="meta-item">
                  <i class="fas fa-clock"></i>
                  2시간 전
        ...
        <div class="main-content">
              ...
              >
                <div class="news-image">
                  <img 
                    ...
                    @error="handleImageError"
                  />
                  <div v-else class="news-placeholder" :class="getNewsImageClass(news.category)">
                    <i :class="getNewsIcon(news.category)" class="fa-2x"></i>
                  </div>
                </div>
                <div class="news-content">
                  <h4 class="news-title">{{ news.title }}</h4>
                  <p class="news-summary">{{ news.summary || '요약 정보가 없습니다.' }}</p>
                  <div class="news-meta">
                    <span class="meta-date">{{ formatDate(news.published_date) }}</span>
            ...
            <div v-else-if="!loading" class="news-grid">
              <div class="news-card">
                ...
                <div class="news-content">
                  ...
                  <p class="news-summary">중앙은행은 오늘 인플레이션 우려와 경제 성장 지원 사이의 균형을 맞춰야 한다며 현재 금리를 유지하겠다고 발표했습니다.</p>
                  <div class="news-meta">
              ...
              <div class="news-card">
                ...
                <div class="news-content">
                  ...
                  <p class="news-summary">기술 부문이 강력한 실적 보고서와 미래 혁신에 대한 낙관론에 힘입어 오늘 다른 산업을 앞섰습니다.</p>
                  <div class="news-meta">
              ...
              <div class="news-card">
                ...
                <div class="news-content">
                  ...
                  <p class="news-summary">주요 암호화폐들이 이번 주 긍정적인 모멘텀을 보이며, 비트코인과 이더리움이 시장 회복을 주도하고 있습니다.</p>
                  <div class="news-meta">
          ...
          <div class="sidebar">
              ...
              <div class="market-summary">
                <div class="market-item">
                  <div class="market-info">
                    ...
                    <span class="market-value up">2,485.47 <i class="fas fa-arrow-up"></i></span>
                  </div>
                ...
                <div class="market-item">
                  <div class="market-info">
                    ...
                    <span class="market-value down">843.81 <i class="fas fa-arrow-down"></i></span>
                  </div>
                ...
                <div class="market-item">
                  <div class="market-info">
                    ...
                    <span class="market-value up">1,345.40 <i class="fas fa-arrow-up"></i></span>
                  </div>
            ...
            <!-- Trending Topics -->
            <div class="widget">
              <h4 class="widget-title">인기 토픽</h4>
              <div class="trending-topics">
                <span class="topic-tag">#금리</span>
                <span class="topic-tag">#인플레이션</span>
                <span class="topic-tag">#기술주</span>
                <span class="topic-tag">#중앙은행</span>
                <span class="topic-tag">#시장변동성</span>
                <span class="topic-tag">#암호화폐</span>
              </div>
            </div>
            ...
            <div class="widget newsletter-widget">
              ...
              <p class="newsletter-desc">최신 금융 뉴스를 이메일로 받아보세요.</p>
              <div class="newsletter-form">
                <input type="email" class="newsletter-input" placeholder="이메일 주소 입력">
...
const crawlAndFetchNews = async () => {
  ...
  try {
    ...
    crawlingMessage.value = '뉴스 로딩 중 오류가 발생했습니다. 캐시된 기사를 표시합니다...'
