...
class StockRecommendation(models.Model):
    """주식 추천 결과"""
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='stock_recommendations')
...
class SavingRecommendation(models.Model):
    """예적금 추천 결과"""
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='saving_recommendations')
